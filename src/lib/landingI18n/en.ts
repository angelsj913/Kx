...
const en: Record<keyof typeof ko, string> = {
  ...
  "hero.modal.androidNote": "Install ZEFF AI from Google Play.",
  "hero.modal.instruction": "Run the downloaded file and follow the on-screen instructions.",
  "hero.modal.confirm": "Get installer",
  "hero.modal.androidOpen": "Open Play Store",
  "hero.modal.cancel": "Cancel",
  "hero.modal.macComingSoon": "The macOS build is coming soon. Please use the Windows installer for now.",
  ...
  "features.subtitle": "Lecture summaries, document drafts, library search — all at once.",
  ...
  "pricing.pro.bullet4": "Stronger AI models tried first",
  ...
  "pricing.professional.bullet3": "Top-tier AI models first, plus careful verification",
  ...
  "login.2fa.verify": "Verify and sign in",
  "login.2fa.error": "The code is incorrect or has expired.",
  ...
  "support.inquiry.detail.question": "Your question",
  "support.inquiry.detail.answer": "Reply",
  ...
  "support.faq.q9": "What AI model powers ZEFF AI?",
  "support.faq.a9": "ZEFF AI isn't built on a single fixed model — it automatically picks the best-fitting model from several AI providers for each request, and paying plans get stronger models tried first. Specialized features like PPT/Excel generation and exam analysis are finely tuned, and free-form chat (general conversation, coding, writing) is broadly capable too. Like any AI, it can occasionally be wrong, so please double-check anything important.",
  ...
  "skills.subtitle": "From content creation to STEM analysis and reports, AI goes deep.",
