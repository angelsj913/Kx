...
const DICT = {
  ko: {
    ...
    "pricing.professional.desc":
      "복잡하고 거대한 규모의 프로젝트를 주도하며 자원의 제약 없이 아이디어를 실현하고자 하는 분들을 위한 최상위 구성입니다. 가장 깊이 있는 고성능 추론 모델과 압도적인 처리 속도가 일상에 완전히 녹아듭니다.",
    "pricing.professional.originalPrice": "₩39,900",
    "pricing.professional.discount": "40% 할인",
  ...
  en: {
    ...
    "pricing.pro.desc":
      "Built for anyone who wants a little more room to work in. It smooths out the everyday rhythm of your tasks, with noticeably more headroom than the basic plan supporting you along the way.",
