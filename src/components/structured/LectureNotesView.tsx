        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="flex flex-col rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/40 p-4">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-200">핵심 개념 · 큐</h3>
              <button
                type="button"
                onClick={addConcept}
          ...
          <div className="flex flex-col rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/40 p-4">
            <h3 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-200">강의 필기</h3>
            <textarea
